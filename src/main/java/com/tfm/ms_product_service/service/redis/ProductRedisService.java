package com.tfm.ms_product_service.service.redis;
...
public class ProductRedisService {
    ...
    public Product getProduct(String id) {
        logger.info("Product not in Redis, searching in DB");
